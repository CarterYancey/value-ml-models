# Experiment report — lightgbm_ranks-technical_2y_beat_spy_393bbf9d

- run id: `e4b649389a65`
- dataset version: `1.1` (pinned, immutable)
- config hash: `50b84f9a22a646bf`
...
| ----------------- | ------ | --------- | --------------- | ---------- | ------ | --------------- | ------ |
| 2022 (rate-shock) | 18267  | 0.2130    | 0.0286          | 0.6703     | 0.2281 | 0.1676          | 0.2083 |
| 2023              | 16875  | 0.1889    | 0               | 0.6786     | 0.2347 | 0.1532          | 0.1719 |
| 2024              | 10445  | 0.2353    | 0.0286          | 0.6717     | 0.2314 | 0.1799          | 0.2252 |
| pooled*           | 45587  | 0.2092    | 0.0190          | 0.6735     | 0.2313 | 0.1654          | 0.1975 |
...
| ------------ | ------- | -------------- | ---------- | --------- | ---- |
| top 5/yr     | 15      | 5              | 0.6787     | 0.0667    | 1    |
| top 10/yr    | 30      | 10             | 0.6766     | 0.0333    | 1    |
| top 20/yr    | 60      | 20             | 0.6747     | 0.0167    | 1    |
| top 50/yr    | 150     | 50             | 0.6726     | 0.0133    | 2    |
| score >= 0.9 | 0       | 0              | —          | —         | 0    |
| score >= 0.8 | 0       | 0              | —          | —         | 0    |
| score >= 0.7 | 0       | 0              | —          | —         | 0    |
| score >= 0.6 | 3019    | 1006.3000      | 0.6390     | 0.0596    | 180  |
| score >= 0.5 | 14211   | 4737           | 0.5628     | 0.2163    | 3074 |
...
![calibration curve](lightgbm_ranks-technical_2y_beat_spy_393bbf9d_calibration.png)
...
| --------------- | ------ | ----------- | --------- | ------ | ------- | ------ | --------------- | --------------- | ---------- | ------------ | -------------------- |
| rate-shock 2022 | 18267  | 871.6788    | 0.2130    | 0.2083 | 0.5359  | 0.2281 | 0.1676          | 0.0286          | 0.6703     | 0.0002       | [0.01, 0.15]         |
